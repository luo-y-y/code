...
import com.cat.common.anon.Anno;
...
public class ExtInterfaceHandAspect{
   ...
   public Object doActionClient(ProceedingJoinPoint pjp)
      ...
      try{
         ...
         map.put("appId", appId);
         map.put("method", pjp.getSignature().getName());
         map.put("methodName", getControllerMethodDescription(pjp));
         ...
         String datagrm = RJson.getJsonStr(map).toString();
         // 记录后台请求报文日志
      ...
      try{
         String str = "";
         if(null != o){
            str = RJson.getJsonStr(o).toString();
         }
